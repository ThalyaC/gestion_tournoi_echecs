...
from vues.chessplayers import register_player, ffe_check
...
def registration_data_chessplayer_tournament(
    ...
    player_tournament1 = PlayerTournament(
        player_ffe=seek_player["Numero FFE"], score=0, former_adversaries=[]
    )
